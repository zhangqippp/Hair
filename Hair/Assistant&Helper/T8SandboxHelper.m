...
//  tinfinite
//
//  Created by yewei on 15/1/19.
//  Copyright (c) 2015年 Tinfinite. All rights reserved.
//
...
SYNTHESIZE_SINGLETON_FOR_CLASS(T8SandboxHelper)
...
+ (NSString *)appPath
{
    return [[T8SandboxHelper sharedT8SandboxHelper] appPath];
}
...
+ (NSString *)docPath
{
    return [[T8SandboxHelper sharedT8SandboxHelper] docPath];
}
...
{
    return [[T8SandboxHelper sharedT8SandboxHelper] libPrefPath];
}
...
{
    return [[T8SandboxHelper sharedT8SandboxHelper] libCachePath];
}
...
+ (NSString *)tmpPath
{
    return [[T8SandboxHelper sharedT8SandboxHelper] tmpPath];
}
...
+ (NSString *)resPath:(NSString *)file{
    return [[T8SandboxHelper sharedT8SandboxHelper] resPath:file];
}
...
{
    return [[T8SandboxHelper sharedT8SandboxHelper] touch:path];
}
...
{
    return [[T8SandboxHelper sharedT8SandboxHelper] touchFile:file];
}
